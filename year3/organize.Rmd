...
- Digital options: OneNote, Evernote, Notion, just text files in a folder
...
- **Ongoing research** is for actual working projects
    ...
    - Subsections for "meeting notes", "drafts", "ideas/thoughts", and "tasks"
...
Key is to have a system where files are named appropriately and everything is easily accessible. Basically its a closet for your research.
...
- My system: manage on my own
  ...
  - In Linux, `ln -s [OPTIONS] FILE LINK`
